...
public class MatchFragment extends Fragment implements OnClickListener {
	...
	class Client extends AsyncTask<String, String, String> implements Closeable {
		...
		protected void onPreExecute() {
	        ...
	        Calendar c = Calendar.getInstance();
			SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			log.setText("[" + df.format(c.getTime()) + "] Trying to Connect to Server ... \n\n");
	        log.append("[" + df.format(c.getTime()) + "] Connected to Server ! \n\n");
		...
		protected void onProgressUpdate(String... result) {
			...
			if (connected == false) {
				...
				Calendar c = Calendar.getInstance();
				SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	        	log.append("[" + df.format(c.getTime()) + "] Error ! Please Start Over.\n\n");
